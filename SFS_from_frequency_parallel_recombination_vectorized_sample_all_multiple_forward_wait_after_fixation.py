...
def runner(idx):
    ...
    if np.mod(idx, 200) == 0:
        np.savetxt('SFS_L={}_N={}_s={:.6f}_m={:.6f}_r={:.6f}_tfinal={}_nsample={}_tfix={}_sample_uniform_n={}_{}.txt'.format(L,
...
if __name__ == '__main__':
    ...
    SFS /= N_SFS
    np.savetxt('SFS_L={}_N={}_s={:.6f}_m={:.6f}_r={:.6f}_tfinal={}_nsample={}_tfix={}_sample_uniform_navg={}_{}.txt'.format(L,
                N, s, m, r, tfinal, nbase, T_after_fix, N_SFS, n_forward), SFS)
    np.savetxt('H_L={}_N={}_s={:.6f}_m={:.6f}_r={:.6f}_tfinal={}_nsample={}_tfix={}_sample_uniform_navg={}_{}.txt'.format(L,
