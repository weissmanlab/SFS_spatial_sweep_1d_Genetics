...
python expected_SFS_parallel_recombination_vectorized_mixing_x10_multiple_forward_wait_after_fixation.py {} {} {:.6f} {:.6f} {:.6f} {} {} {} {} {} {}   # last digit is for copy number of the foward time sim
'''
...
for n in range(100):
    filename = 'expected_L={}_N={}_s={:.6f}_m={:.6f}_r={:.6f}_tfinal={}_Un={}_nsample={}_tfix={}_mixing_x10_{}.sh'.format(
